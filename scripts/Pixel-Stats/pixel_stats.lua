...
if (not cancel) then
  ...
  print("");
  print("--==" .. Pixel_Stats_I18n:get("msg_title") .. "==--");
  if (selected) then
    print(Pixel_Stats_I18n:get("selected_text1") .. " " .. box.width .. "x" .. box.height);
  else
    print(Pixel_Stats_I18n:get("selected_text2") .. " " .. img.width .. "x" .. img.height);
  end
  print(Pixel_Stats_I18n:get("total_text1") .. " " .. pixelAmt);
  print(Pixel_Stats_I18n:get("total_text2") .. " " .. #pixelStuff);
  print(" ");
  ...
  if (overMax) then
    ...
    print(Pixel_Stats_I18n:ger("e_text6"))
    print("\n\n")
  else
    -- Grouped color stats
